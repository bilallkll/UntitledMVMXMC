...
public class RollEnemy : MonoBehaviour
{
    ...
    {
        RaycastHit2D hitLeft = Physics2D.Raycast((Vector2)transform.position, Vector2.left, wallDetectHeight, globalVar.groundMask);
        RaycastHit2D hitRight = Physics2D.Raycast((Vector2)transform.position, Vector2.right, wallDetectHeight, globalVar.groundMask);
